...
import com.hoodgo.entity.*;
import com.hoodgo.exception.AddressBookBusinessException;
import com.hoodgo.exception.OrderBusinessException;
import com.hoodgo.exception.ShoppingCartBusinessException;
import com.hoodgo.mapper.*;
import com.hoodgo.result.PageResult;
import com.hoodgo.service.OrderService;
import com.hoodgo.utils.TencentMapUtil;
import com.hoodgo.utils.WeChatPayUtil;
...
import com.hoodgo.websocket.WebSocketServer;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderSubmitVO submitOrder(OrdersSubmitDTO ordersSubmitDTO) {
        ...
        if(!tencentMapUtil.inRangeByAddress(address))
            throw new AddressBookBusinessException(MessageConstant.ADDRESS_BOOK_FAILED);
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        //调用微信支付接口，生成预支付交易单
        JSONObject jsonObject = weChatPayUtil.miniPay(
    ...
    public void userCancelById(Long id) {
        ...
        if (ordersDB.getStatus() > 4) {
            ...
            throw new OrderBusinessException(MessageConstant.COMMUNICATE);
        }
